...
def test_compare_stores_grouping():
    ...
    c.execute("INSERT INTO products (product_id, store_id, name, brand, normalized_name, quantity, unit, normalized_quantity, normalized_unit, fingerprint) VALUES ('p1', 's1', 'Coca Cola Original 2 L', 'Coca-Cola', 'original', 2, 'L', 2, 'L', 'coca cola|original|2|l')")
    c.execute("INSERT INTO products (product_id, store_id, name, brand, normalized_name, quantity, unit, normalized_quantity, normalized_unit, fingerprint) VALUES ('p2', 's2', 'Coca-Cola Refresco Original 2000 ml', 'Coca-Cola', 'refresco original', 2000, 'ml', 2, 'L', 'coca cola|refresco original|2|l')")
    c.execute("INSERT INTO products (product_id, store_id, name, brand, normalized_name, quantity, unit, normalized_quantity, normalized_unit, fingerprint) VALUES ('p3', 's3', 'Coca Cola Zero 2 L', 'Coca-Cola', 'zero', 2, 'L', 2, 'L', 'coca cola|zero|2|l')")
